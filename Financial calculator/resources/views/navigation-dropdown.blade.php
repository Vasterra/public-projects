<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 nav__admin">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('indicators') }}" :active="request()->routeIs('indicators')">
                        {{ __('Forecast data') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('companies') }}" :active="request()->routeIs('companies')">
                        {{ __('Companies') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('formula') }}" :active="request()->routeIs('formula')">
                        {{ __('Formulas') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('forecasts') }}" :active="request()->routeIs('forecasts')">
                        {{ __('Forecasts') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('home') }}" target="_blank" class="font-weight-bold">
                        {{ __('Home') }}
                    </x-jet-nav-link>
                </div>
            </div>
