...
class planFX
{
    ...
    public $api_key = 'xxxxxxxxxxxxxxxxxxxxxx';
    public $api_secret = 'xxxxxxxxxxxxxxxxxxxxxxxxx';
    public $api_token = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
    ...
    {
        $requestXml->account = 'xxxxxxxxxxxx';
...
class reactionUI extends PDO
{
	...
	public function __construct($unm, $uid, $idmsg, $dt, $ms, $chatID, $file = 'my_setting.ini')
    {
        ...
        $this->access=0;
        $this->url='https://api.telegram.org/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/sendMessage';
        $this->urldoc='https://api.telegram.org/xxxxxxxxxxxxxxxxxxxxxxxxxxxx/sendDocument';
